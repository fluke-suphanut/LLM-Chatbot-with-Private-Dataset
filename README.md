...
โครงการนี้เป็นการสร้าง LLM Chatbot ที่เชื่อมต่อกับ Private Dataset จาก Agnos Health Forum โดยใช้เทคนิค RAG (Retrieval-Augmented Generation) เพื่อให้ Chatbot สามารถค้นหาและตอบคำถามจากข้อมูลในฐานข้อมูลได้อย่างถูกต้องและครบถ้วน
